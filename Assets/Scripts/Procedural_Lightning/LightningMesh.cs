...
namespace GameDevBuddies.ProceduralLightning
{
    ...
    public class LightningMesh
    {
        ...
        /// <summary>
        /// Reference to the <see cref="UnityEngine.Mesh"/> of the lightning.
        /// </summary>
        ...
        public void UpdateMesh(List<LightningBranch> lightningBranches, int segmentResolution, float segmentRadius)
        {
        ...
        private void UpdatePointVertices(ref Vector3[] vertices, ref int vertexIndex, LightningPoint lightningPoint, float segmentRadius)
        {
            ...
            Vector3 forward = lightningPoint.PointForward;
            Vector3 right = lightningPoint.PointRight;
